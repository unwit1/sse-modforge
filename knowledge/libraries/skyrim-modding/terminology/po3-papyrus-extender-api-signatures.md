# powerofthree Papyrus Extender — PO3_SKSEFunctions API Signatures

Imported: 2026-09-24
Upstream: `powerof3/PapyrusExtenderSSE` master
Source: `Papyrus/Source/scripts/PO3_SKSEFunctions.psc`
Source blob SHA: `87fcdd7c399801c92449c59ddb46090b2cc93214`
Extracted function declarations: 379
...
This file is a provider-level exact-signature index. Use subsystem modules for semantics and caveats, especially:
- actor/process/world queries;
- reference/node/material manipulation;
- form/keyword mutation;
- spell/potion/scroll effect manipulation;
- projectile data;
- quest/scene helpers;
- menu/UI helpers;
- weather/environment helpers.

A declared native function still depends on the correct Papyrus Extender DLL/runtime registering it successfully.
